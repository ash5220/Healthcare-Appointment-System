...
export const register = asyncHandler(async (req: Request, res: Response) => {
    ...
    createdResponse(res, { user: result.user, accessToken: result.accessToken }, 'Registration successful');
});
...
export const registerPatient = asyncHandler(async (req: Request, res: Response) => {
    ...
    createdResponse(res, { user: result.user, accessToken: result.accessToken }, 'Patient registration successful');
});
...
export const registerDoctor = asyncHandler(async (req: Request, res: Response) => {
    ...
    createdResponse(res, { user: result.user, accessToken: result.accessToken }, 'Doctor registration successful');
});
