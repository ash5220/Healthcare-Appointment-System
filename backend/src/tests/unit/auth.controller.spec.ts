...
describe('Auth Controller', () => {
  ...
  describe('registerPatient', () => {
    ...
    it('throws BadRequestError when dateOfBirth or gender is missing', async () => {
      const req = mockReq({ body: { ...body, dateOfBirth: undefined } });
      const res = mockRes();
  ...
  describe('verifyMfaLogin', () => {
    ...
    it('forwards errors to next()', async () => {
      ...
      const req = mockReq({ body: { tempToken: 't', token: '0' } });
      const res = mockRes();
  ...
  describe('resetPassword', () => {
    it('happy path — resets password and returns 200', async () => {
      ...
      const req = mockReq({ body: { token: 'reset-token', newPassword: 'NewPass1!' } });
      const res = mockRes();
    ...
    it('forwards invalid/expired token error to next()', async () => {
      ...
      const req = mockReq({ body: { token: 'bad', newPassword: 'NewPass1!' } });
      const res = mockRes();
