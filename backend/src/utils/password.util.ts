...
export const isCommonPassword = (password: string): boolean => {
    ...
    const commonPasswords = new Set([
        ...
        'qwerty', 'qwerty123', 'qwerty!', 'qwerty123!', 'qwertyuiop',
        'abc123', 'abc123!', 'abcdef', 'abcdef1',
        'letmein', 'letmein1', 'letmein!',
        'welcome', 'welcome1', 'welcome!', 'welcome123',
        ...
        'soccer', 'soccer1', 'soccer123',
        'hockey', 'hockey1', 'hockey123',
        'michael', 'michael1', 'michael123',
        'charlie', 'charlie1', 'charlie123',
        'donald', 'donald1', 'donald123',
        'passwd', 'pass', 'passw0rd', 'p@ssword', 'p@ssw0rd',
        'p@ssword1', 'p@ssword1!', 'p@$$word', 'pa$$word',
        'test', 'test1', 'test123', 'testing', 'testing1',
