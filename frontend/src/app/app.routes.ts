...
export const routes: Routes = [
    ...
    // Patient routes
    {
        ...
        children: [
            ...
            {
                path: 'appointments',
                loadComponent: () => import('./features/patient/appointments/list/appointment-list.component').then(m => m.AppointmentListComponent),
            },
            {
                path: 'book',
                loadComponent: () => import('./features/patient/appointments/book/book-appointment.component').then(m => m.BookAppointmentComponent),
            },
            {
            ...
            {
                path: 'insurance',
                loadComponent: () => import('./features/patient/insurance/insurance.component').then(m => m.InsuranceComponent),
            },
            {
                path: 'payments',
                loadComponent: () => import('./features/patient/payments/payments.component').then(m => m.PaymentsComponent),
            },
            {
                path: 'messages',
    ...
    // Doctor routes
    {
        ...
        children: [
            ...
            {
                path: 'schedule',
                loadComponent: () => import('./features/doctor/schedule/schedule.component').then(m => m.ScheduleComponent),
            },
            {
                path: 'messages',
                loadComponent: () => import('./features/messaging/messaging.component').then(m => m.MessagingComponent),
    ...
    },
    {
        ...
        loadComponent: () => import('./features/profile/mfa-setup/mfa-setup.component').then(m => m.MfaSetupComponent),
        canActivate: [authGuard],
    },
