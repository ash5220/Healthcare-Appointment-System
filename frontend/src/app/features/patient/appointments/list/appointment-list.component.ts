...
import { AppointmentStatus, Appointment, PaymentMethod } from '../../../../core/models';
import {
  MAX_PAGE_SIZE,
...
export class AppointmentListComponent implements OnInit {
  ...
  /**
   * Initiate a payment for the appointment.
   */
  protected payForAppointment(appointment: Appointment): void {
    ...
    this.paymentService.createPayment({
      ...
      next: () => {
        this.notificationService.success('Payment Initiated', 'Your payment has been successfully initiated.');
      },
      error: (error) => {
        console.error('Failed to initiate payment:', error);
        this.notificationService.error('Error', 'Failed to initiate payment. Please try again later.');
      },
    });
  }
}
