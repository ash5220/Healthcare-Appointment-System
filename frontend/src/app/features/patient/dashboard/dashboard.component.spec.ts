...
describe('PatientDashboardComponent', () => {
    ...
    describe('getStatusBadgeClass', () => {
        it('should return correct class for SCHEDULED status', () => {
            const result = component['getStatusBadgeClass'](AppointmentStatus.SCHEDULED);
            expect(result).toContain('warning');
        });

        it('should return correct class for COMPLETED status', () => {
            const result = component['getStatusBadgeClass'](AppointmentStatus.COMPLETED);
            expect(result).toContain('success');
        });

        it('should return correct class for CANCELLED status', () => {
            const result = component['getStatusBadgeClass'](AppointmentStatus.CANCELLED);
